...
import (
	...
	"github.com/imlida/go-gin-api/internal/dal/model"
)

func newAuthorizedAPI(db *gorm.DB) authorizedAPI {
	_authorizedAPI := authorizedAPI{}

	_authorizedAPI.authorizedAPIDo.UseDB(db)
	...
	_authorizedAPI.ID = field.NewInt32(tableName, "id")
	...
	_authorizedAPI.IsDeleted = field.NewBool(tableName, "is_deleted")
...
type authorizedAPI struct {
	authorizedAPIDo authorizedAPIDo
	...
	IsDeleted   field.Bool   // 是否删除 1:是  -1:否
...
func (a *authorizedAPI) WithContext(ctx context.Context) IAuthorizedAPIDo {
	return a.authorizedAPIDo.WithContext(ctx)
}

func (a authorizedAPI) TableName() string { return a.authorizedAPIDo.TableName() }

func (a authorizedAPI) Alias() string { return a.authorizedAPIDo.Alias() }
